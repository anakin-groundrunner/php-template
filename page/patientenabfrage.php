...
if(isset($_POST['show'])) {
    ...
    if($von == null && $bis == null) {
        ...
        $von = date('Y-m-d H:i:s',strtotime('midnight', strtotime($von)));
        ...
        if ($bis == null) {
            ...
            $bis = date('Y-m-d H:i:s',strtotime('+1 day', strtotime($bis)));
            echo "<label>".date('Y-m-d H:i:s',strtotime($von))." - ".$bis."</label>";
